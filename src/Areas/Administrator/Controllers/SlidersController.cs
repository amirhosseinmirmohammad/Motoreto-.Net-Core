...
namespace GladcherryShopping.Areas.Administrator.Controllers
{
    ...
    public class SlidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Image,Link,CreateDate,LastDate,IsApp")] Slider slider,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Image,Link,CreateDate,LastDate,IsApp")] Slider slider,
            HttpPostedFileBase Image)
        {
            if (ModelState.IsValid)
            {
