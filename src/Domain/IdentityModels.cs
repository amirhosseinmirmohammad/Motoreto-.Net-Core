...
namespace GladcherryShopping.Models
{
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        public ApplicationDbContext()
            : base("Motoreto", throwIfV1Schema: false)
        {
        ...
        public DbSet<QrEntity> QrEntities { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new Chat.Configuration());
            modelBuilder.Configurations.Add(new ChatMessage.Configuration());
