...
namespace DataLayer.Models
{
    public class Application
    {
       public Application() { }
        ...
        [DisplayName("هزینه حمل به ریال")]
        [Display(Name = "هزینه حمل به ریال")]
        public long Transferring { get; set; }

        [DisplayName("هزینه ارسال ویژه به ریال")]
        [Display(Name = "هزینه ارسال ویژه به ریال")]
        public long SpecialTransport { get; set; }
    }
}
